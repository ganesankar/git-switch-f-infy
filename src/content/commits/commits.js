...
export const commits = [
  ...
  // Final chapter — Traceability & data engineering
  { type: 'feat', scope: 'traceability', subject: 'Traceability Application ', emoji: '🕸️', date: '2023-08-01' },
  
  // Awards arc — each one a quiet surprise
  
  // Mid-tenure — building platforms for Nike
  { type: 'feat', scope: 'sourcing-transfer', subject: 'Sourcing Transfer Tracker', emoji: '🔄', date: '2022-05-01' },
  { type: 'feat', scope: 'compliance', subject: 'Compliance Platform ', emoji: '🛡️', date: '2019-06-01' },
  { type: 'experiment', scope: 'playground', subject: 'POCs, hackathons, side quests — never stopped tinkering', emoji: '🧪', date: '2021-01-01' },
  { type: 'style', scope: 'craft', subject: 'code reviews, design systems, accessibility — quality as a default', emoji: '🎨', date: '2020-06-01' },
  ...
  { type: 'merge', scope: 'friendships', subject: 'the colleagues who became family — quietly, completely, they built me', emoji: '🤝', date: '2019-06-01' },
  ...
  { type: 'ops', scope: 'rfp', subject: 'led RFPs across multiple pursuits — won some, learned from all', emoji: '📑', date: '2019-09-05' },
  { type: 'feat', scope: 'capacity-visibility', subject: 'Capacity Visibility', emoji: '📊', date: '2019-01-17' },
  { type: 'feat', scope: 'ajio', subject: 'Bangalore travel — built a retail B2B application for AJIO ', emoji: '🛍️', date: '2018-06-05' },
