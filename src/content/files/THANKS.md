...
> _the longest file in this repo — still not long enough 💛_

Names are deliberately omitted. Not because there are too few — because
there are too many, and naming a few would feel like leaving the rest out.

If you are reading this and wondering whether it is meant for you, **it is.**
...
- 🏆 For the few who shared credit with me, when you could've kept it.
...
> _even if they don't see it_

- 🛡️ To the security guards who scanned my backpack every day, just to make sure I wasn't walking off with company property.
...
If you ever inherit my space:
- ☕ The coffee machine sucks — canteen tea or coffee is somewhat better.
- 🌼 The good people are everywhere; they'll treat you as one of them and give you space to grow.
- 💛 Be kind to whoever is sitting next to you. They might be writing their own `THANKS.md` in a few years.



## p.s. 💌

- 🧾 For everyone I forgot to thank in person — this file is the receipt I owe you.

```bash
$ git log --format="%an" | sort -u | wc -l
# > too many to count, exactly the right number
```
